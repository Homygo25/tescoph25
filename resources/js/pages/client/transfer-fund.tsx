            ...
            <div className="flex h-full flex-1 flex-col items-center gap-y-4 p-4">
                <div className="w-full max-w-[900px]">
                    <Card className="p-4">
                        ...
                        <Input placeholder="Receiver's fullname/username" value={receiver} onChange={(e) => setReceiver(e.target.value)} />
                        <Label>Amount</Label>
                        <Input placeholder="Amount" type="number" value={amount ?? ''} onChange={handleAmountChange} />
                        <p className="text-accent-foreground text-sm">
                            Available: <span className="font-semibold">{formattedNumber(account_balance)}</span>
                        </p>
